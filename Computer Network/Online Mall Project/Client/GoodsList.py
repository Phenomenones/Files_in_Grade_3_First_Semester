...
class CustomerList_Dialog(QDialog): #当前店内用户窗口
    def __init__(self,parent=None):
        super(CustomerList_Dialog,self).__init__(parent)
...
class GoodsList_Dialog(QDialog):    #商店商品窗口
    ...
    def setupUi(self, Dialog):
        ...
        self.listWidget.itemClicked.connect(self.good_item_clicked)#!!!!!!
    ...
    def receive_info(self,dic): #获取当前顾客信息
        ...
        self.UserNameLine.setText("Current User: "+dic["user_name"])
    ...
    def exit(self):
        ...
        res["owner_id"]=str(self.shop_id)
        self.exit_shop.emit(res)
