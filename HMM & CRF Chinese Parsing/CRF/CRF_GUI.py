...
# Form implementation generated from reading ui file 'CRF_GUI.ui'
...
class Ui_Dialog(QDialog):
    def __init__(self,parent=None):
        ...
        self.CRF=joblib.load("CRF_8e6.pkl")
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "CRF Segmentor GUI"))
        self.GUI_Name.setText(_translate("Dialog", "CRF Segmentor GUI"))
    ...
    def partition(self):
        ...
        sen=sen.encode("utf8")
        res=CRF.partition(sen,self.CRF)
        stri=""
        for thing in res:
            stri+=thing
            stri+="  "
